...
export async function createExcepcion(req, res, next, db) {
    ...
    try {
        apiLogger.info('Searching in Actividad for id, es_recurrente, fecha_inicio, fecha_fin, tiempo_inicio');
...
export async function getExcepcionById(req, res, next, db) {
...
export async function getExcepcionesOfActividad(req, res, next, db) {
    ...
    try {
        ...
        apiLogger.info('Searching in Excepcion for id');
...
export async function verifyActividad(db, fecha_inicio_act, query_act, actividadId) {
