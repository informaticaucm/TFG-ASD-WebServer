...
export async function getActividadesOfUsuario(req, res, next, db) {
...
export async function getActividadesOfEspacio(req, res, next, db) {
...
export async function getActividadesOfClase(req, res, next, db) {
...
export async function getActividadById(req, res, next, db) {
    ...
    try {
        apiLogger.info('Searching in Actividad for id, fecha_inicio, fecha_fin, tiempo_inicio, tiempo_fin, es_todo_el_dia, es_recurrente');
