...
export function model(sequelize) {
    ...
    Docente.associate = function (models) {
        ...
        models.Departamento.hasMany(models.Docente, { as: 'Miembros_de', foreignKey: { name: 'departamento_id', allowNull: false }}); //Un departamento tiene varios docentes
        models.Departamento.belongsToMany(models.Docente, { as: 'pertenece_a', through: { model: models.Join_Departamento_Docentes, foreignKey: 'docente_id', allowNull: false }, foreignKey: 'docente_id' });
